...
public class StudentService(GenericRepository<Student> repo, IMapper mapper)
    : CrudServiceBase<Student, StudentBusiness, StudentResponse, CreateStudentRequest, UpdateStudentRequest>(repo, mapper)
{
