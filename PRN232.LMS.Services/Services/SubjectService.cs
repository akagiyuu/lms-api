...
public class SubjectService(GenericRepository<Subject> repo, IMapper mapper)
    : CrudServiceBase<Subject, SubjectBusiness, SubjectResponse, CreateSubjectRequest, UpdateSubjectRequest>(repo, mapper)
{
