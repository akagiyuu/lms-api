...
public class SemestersController(SemesterService service) : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<SemesterResponse>>> GetById([FromRoute] int id)
    {
        ...
        return data is null ? NotFound(ApiResponse<SemesterResponse>.Fail("Semester not found"))
                            : Ok(ApiResponse<SemesterResponse>.Ok(data));
    }
    ...
    public async Task<ActionResult<ApiResponse<SemesterResponse>>> Create([FromBody] CreateSemesterRequest request)
    {
        ...
        return StatusCode(201, ApiResponse<SemesterResponse>.Ok(data));
    }
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<object>>> Patch([FromRoute] int id, [FromBody] UpdateSemesterRequest request)
